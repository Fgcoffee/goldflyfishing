...
from ..cr100_game_concepts.player import Player
...
class Game:
    ...
    #: See ``rules.cr500_turn_structure.cr500_turn.ACTION_BUDGET``: a game that spends its budget is
    ...
    #: noticing a loop. See rules.kernel.loops.
    ...
    def move_object(
        ...
        *,
        ...
        from ..cr300_card_types.cr300_card_types import forget_designations
    ...
    def _emit_zone_specific(
        ...
        if to_zone is Zone.BATTLEFIELD:
            ...
            from ..cr600_spells_and_abilities.cr614_replacement import apply_self_entry_replacements
    ...
    def board(self, requesting: GameObject | None = None) -> dict:
        ...
        if self._board is not None and self._board_epoch == self.epoch:
            return self._board
        from ..cr600_spells_and_abilities.cr613_layers import compute_board
    ...
    def characteristics(self, obj: GameObject) -> Characteristics:
        ...
        from ..cr600_spells_and_abilities.cr613_layers import compute_characteristics
    ...
    def has_replacements(self) -> bool:
        ...
        if self.replacement_effects:
            return True
        from ..cr600_spells_and_abilities.cr614_replacement import static_replacements
